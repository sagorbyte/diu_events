...
class _StudentEditProfileScreenState extends State<StudentEditProfileScreen> {
  ...
  void _initializeData() {
    ...
    if (authProvider.user != null) {
      ...
      // Load student-specific data from user profile
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    // Phone Number Field with +880 prefix
                    _buildPhoneField(),
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            items: DepartmentConstants.facultiesAndDepartments.keys
                .map(
        ...
        Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            items: _selectedFaculty != null
                ? DepartmentConstants.getDepartmentsByFaculty(_selectedFaculty!)
                      .map(
            ...
            Expanded(
              child: TextFormField(
                ...
                validator: (value) {
                  ...
                  // Validate Bangladesh phone number (should be 11 digits after +880)
